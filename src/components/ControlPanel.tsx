...
export default function ControlPanel({ selectedVariable, setSelectedVariable }) {
            ...
            <Box sx={{ minWidth: 120 }}>
                <FormControl fullWidth>
                    ...
                    <Select
                        ...
                        id="simple-select"
                        label="Variables"
                        value={selectedVariable.toString()}
                        onChange={handleChange}
                    >
                        <MenuItem key="-1" value="-1">Seleccione una variable</MenuItem>
                        {options}
                    </Select>
                </FormControl>
            </Box>
